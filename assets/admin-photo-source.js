(()=>{
  ...
  const loadManager=()=>{const manager=document.createElement('script');manager.src='assets/admin-content-manager.js?v=20260922-authors';document.body.appendChild(manager)};
